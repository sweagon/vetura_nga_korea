        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="bg-ferrari-red text-primary px-4 py-2 rounded-full text-sm font-semibold">
                        Matchmaker aktiv
                    </div>
                </div>
            </div>
                ...
                <AnimatePresence>
                    {recommendations.map((car, index) => (
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="absolute top-4 right-4 z-10 bg-ferrari-red text-primary px-3 py-1 rounded-full text-sm font-semibold shadow-lg">
