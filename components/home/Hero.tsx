    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 mix-blend-overlay">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_50%,var(--color-orange-40)_0%,transparent_50%)]" />
          <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_70%_80%,var(--color-orange-40)_0%,transparent_50%)]" />
        </div>
      </div>
      ...
      <div className="container-swiss relative lg:text-left text-center">
        ...
        >
          ...
          >
            Garanci në motorr, pa kilometra të ndërruara, pa aksidente. 20 ditë
            ose 1,000 km garanci.
          </motion.p>
              ...
              >
                <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                  <div className="p-1.5 md:p-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/10">
                    <stat.icon
                      size={16}
                      className="md:w-5 md:h-5 text-orange-500"
                    />
                  </div>
