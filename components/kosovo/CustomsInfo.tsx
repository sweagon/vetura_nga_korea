            ...
            <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                    <div className="bg-secondary p-3 rounded-lg">
                        <p className="text-xs text-gray-500">Dogana</p>
                        <p className="font-bold text-ferrari-red">10%</p>
                    </div>
                    <div className="bg-secondary p-3 rounded-lg">
                        <p className="text-xs text-gray-500">TVSH</p>
                ...
                <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                        <Euro size={16} className="text-gray-400 mt-1" />
                        <div>
                            <p className="font-medium">Makina nën 10 vjet</p>
                            <p className="text-sm text-gray-600">Dogana 10% + TVSH 18%</p>
                        </div>
                    </div>
                    <div className="flex items-start space-x-2">
                        <Euro size={16} className="text-gray-400 mt-1" />
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Dogana 10% + TVSH 18% + taksë shtesë</p>
                        </div>
                    </div>
                </div>
