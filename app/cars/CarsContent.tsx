...
import { fetchCars, type Car } from '@/lib/api'; // ✅ Import Car type from api
import { ChevronLeft, ChevronRight, Loader2, XCircle, Car as CarIcon, SlidersHorizontal, Search } from 'lucide-react'; // ✅ Rename Car icon import

// ❌ REMOVE this local interface - it's duplicated
// interface Car {
//     id: number;
//     make: string;
//     model: string;
...
const queryCache = new Map<string, Car[]>(); // ✅ Now using imported Car type
            ...
            <div className="container-custom py-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    <div className="hidden lg:block lg:w-1/5">
                        <div className="bg-surface rounded-xl border border-medium p-4 h-96 animate-pulse"></div>
                    </div>
                    <div className="w-full lg:w-4/5">
                        <div className="h-10 bg-surface-2 rounded-lg mb-6 w-64 animate-pulse"></div>
                    ...
                    {currentCars.length === 0 ? (
                        <div className="text-center py-16 bg-surface rounded-xl border border-medium">
                            <div className="w-20 h-20 bg-ferrari-red/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                <CarIcon size={32} className="text-ferrari-red" /> {/* ✅ Use renamed CarIcon */}
                            </div>
