    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center bg-primary">
            <div className="container-custom max-w-2xl text-center">
                <div className="bg-surface rounded-2xl p-12 shadow-xl border border-medium">
                    <div className="w-24 h-24 bg-ferrari-red/10 rounded-full flex items-center justify-center mx-auto mb-6">
                        <Car size={48} className="text-ferrari-red" />
                    </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-medium">
                        <p className="text-sm text-muted">
                            Nëse mendoni se ky është një gabim, na kontaktoni për ndihmë.
                        </p>
                        <Link
                            href="/contact"
                            className="inline-block mt-2 text-ferrari-red hover:underline text-sm"
                        >
                            Kontakto support →
                        </Link>
                    </div>
