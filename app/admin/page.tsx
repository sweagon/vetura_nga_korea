...
export default function AdminPage() {
    ...
    const handleReset = () => {
        if (confirm('A jeni i sigurt që doni të riktheni vlerat e paracaktuara?')) {
            const defaultConfig = {
                shippingCost: 3500,
                shippingToPristina: 350, // Add this line
                markupPercentage: 15,
                minimumMarkup: 1000,
            ...
            <div className="container-swiss max-w-4xl">
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                        ...
                        {/* Transporti në Prishtinë Card */}
                        <div className="bg-surface/30 backdrop-blur-sm border border-light/20 rounded-xl p-4 sm:p-5 md:p-6">
                            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                                <div className="p-1.5 sm:p-2 bg-orange-500/10 rounded-lg">
                                    <Truck className="w-4 h-4 sm:w-5 sm:h-5 text-orange-500" />
                                </div>
                                <h3 className="text-sm sm:text-base font-medium text-primary">Transporti Prishtinë</h3>
                            </div>
                            <div className="relative">
                                <span className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 text-xs sm:text-sm text-muted">€</span>
                                <input
                            ...
                            <p className="text-xs text-muted mt-2">Transport shtesë nga Durrësi në Prishtinë</p>
                        </div>
